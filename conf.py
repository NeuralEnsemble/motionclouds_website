...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
                   ...
                   ('/archive.html', 'How-to'),
                   ('https://laurentperrinet.github.io/sciblog/categories/motionclouds.html', 'Examples'),
                   ...
                   ('https://github.com/NeuralEnsemble/MotionClouds', 'Github'),
                   )
}
...
OUTPUT_FOLDER = '../MotionClouds/docs'
