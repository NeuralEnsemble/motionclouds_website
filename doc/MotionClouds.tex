...
\newcommand{\AddressB}{Institut de Neurosciences de la Tim{\^o}ne, CNRS / Aix-Marseille University, Marseille, France}%
...
%% new float to avoid putting the tables at the end
%\floatstyle{plain}
...
%\usepackage{endfloat}%[notablist,notabhead]
%\makeatletter
...
%\pagestyle{empty}
%\pagenumbering{roman}
%\renewcommand*\thesection{\arabic{section}} % so we do not get the annoying 0 from chapter
...
%%%%%%%%%%%%%%%%%%% Include files %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Include abstract page as asked by jn
\begin{abstract}
\Abstract
\end{abstract}%
\section*{Keywords}
