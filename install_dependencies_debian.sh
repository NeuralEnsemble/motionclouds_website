...
#
sudo aptitude install ilibavcodec-extra-53 python-numpy python-scipy mayavi2 python-matplotlib ffmpeg spyder liblzo2-2 python-tables imagemagick texlive-latex-recommended latexmk latexdiff zip
